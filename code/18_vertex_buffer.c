...
void createVertexBuffer(struct application *app) {
	...
	bufferInfo.size = sizeof(vertices[0]) * 3;/*magic number is number of vertices*/
	...
	allocInfo.memoryTypeIndex = findMemoryType(app,memRequirements.memoryTypeBits, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT);
